...
export default function AdminAlerts() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* Security Alert */}
      <div className="bg-[#fdf2f2] rounded-md p-5 border-l-4 border-l-red-600 shadow-sm flex flex-col justify-between">
        <div>
        ...
        <button className="w-full py-2 bg-[#b91c1c] hover:bg-[#991b1b] text-white rounded-md text-[13px] font-semibold transition-colors">
          Dispatch Security Check
        </button>
      </div>

      {/* Financial Alert */}
      <div className="bg-[#fff7ed] rounded-md p-5 border-l-4 border-l-orange-500 shadow-sm flex flex-col justify-between">
        <div>
          <h3 className="text-base font-bold text-slate-900 flex items-center gap-2 mb-3">
        ...
        <button className="w-full py-2 bg-[#f97316] hover:bg-[#ea580c] text-white rounded-md text-[13px] font-semibold transition-colors">
          Send Reminder SMS
        </button>
      </div>
    </div>
