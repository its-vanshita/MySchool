...
export default function TeacherHomework() {
  ...
  return (
    <div className="flex flex-col h-full space-y-6">
      ...
      {/* Main Form */}
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex-1 overflow-y-auto min-h-0">
        <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col max-w-4xl mx-auto">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {!attachment ? (
                <div className="mt-2 flex justify-center rounded-xl border border-dashed border-slate-300 px-6 py-8 bg-slate-50 hover:bg-slate-100 transition-colors relative">
